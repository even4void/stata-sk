...
Voici un exemple plus élaboré, tiré directement de l'ouvrage de @kohler-2012-data-analy :
...
Un diagramme en points [@cleveland-1985-elemen-graph-data], qui reste préférable à un diagramme en barres, pour le même indicateur de tendance centrale que ci-dessus peut être construit à l'aide de ces instructions :[fn:3]
