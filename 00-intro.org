...
graph export "fig-00-scatter-price-mpg.eps", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-00-scatter-price-mpg2.eps", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-00-rvfplot-price-mpg2.eps", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-00-rvfplot-price-mpg2-b.eps", fontface(DroidSans) replace
#+END_SRC
