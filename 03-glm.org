...
La commande [[stata:lowess][lowess]] peut être combinée à [[stata:scatter][scatter]] :
...
Bien que l'analyse bayésienne soit traitée dans un chapitre à part, on peut d'ores et déjà jeter un oeil aux résultats fournis à l'aide d'une estimation bayésienne grâce au préfixe [[stata:bayes][bayes]] :
