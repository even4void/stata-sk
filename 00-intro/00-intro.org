...
graph export "fig-scatter-price-mpg.pdf", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-scatter-price-mpg2.pdf", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-rvfplot-price-mpg2.pdf", fontface(DroidSans) replace
#+END_SRC
...
graph export "fig-rvfplot-price-mpg2-b.pdf", fontface(DroidSans) replace
#+END_SRC
...
Comme on peut le constater, les tableaux renvoyés par Stata dans la fenêtre de résultats sont relativement convenables pour une lecture à l'écran.
